...
export function buildOptions ({ development = false, sourceMaps = development, futureFeatures = process.env.ZILLION_FUTURE_FEATURES !== '0', projectRoot = root, onStart = () => {}, onEnd = () => {} } = {}) {
